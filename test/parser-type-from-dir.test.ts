 ...
 * Before this, such a file parsed as `artifactType: 'Snippet'` and `performInsert`
...
suite('parser — artifact type inferred from the vault directory', () => {
    ...
    test('a Commands file with no frontmatter parses as artifactType: Command', () => {
    ...
    test('a Snippets file with no frontmatter still parses as artifactType: Snippet', () => {
